                  ...
                  <div className="border p-2 mb-6">
                    ...
                    <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" placeholder="Enter Phone No" className="w-full px-3 py-2 border"/>
                        </div>
                    </div>
                  ...
                  <div className="border p-2 mb-6">
                    ...
                    <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                        <div>
                            ...
                            <input type="text" name="address" placeholder="Address" className="w-full px-3 py-2 border"
                                onChange={(e)=>setShippingInfo({...shippingInfo, address:e.target.value})}
                            />
                        </div>
                        <div>
                            <label htmlFor="" className="block text-gray-700">City</label>
                            <input type="text" name="city" placeholder="City Name" className="w-full px-3 py-2 border"
                        ...
                        <div>
                            ...
                            <input type="text" name="zip" placeholder="Zip-code" className="w-full px-3 py-2 border"
                        ...
                        {paymentMethod === "dc" && (
                            <div className=" bg-gray-200 p-4 rounded-lg mb-4 shadow-md border">
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="Enter Expiry Date" className="border p-2 w-full rounded"/>
                                </div>
                                <div>
                            ...
                            <div key={product.id} className="flex justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600">&{product.price} x {product.totalQuantity}</p>
                                    </div>
                                </div>
